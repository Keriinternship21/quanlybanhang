...
public class DialogDoanhThuragment extends AppCompatDialogFragment {

    static DialogDoanhThuragment newInstance(){
        return new DialogDoanhThuragment();
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setStyle(DialogDoanhThuragment.STYLE_NORMAL, R.style.FullsCreen);
    }
