...
public class DialogQLGBragment extends AppCompatDialogFragment {

    static DialogQLGBragment newInstance(){
        return new DialogQLGBragment();
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setStyle(DialogQLGBragment.STYLE_NORMAL, R.style.FullsCreen);
    }
