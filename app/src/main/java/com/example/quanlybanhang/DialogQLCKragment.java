...
public class DialogQLCKragment extends AppCompatDialogFragment {

    static DialogQLCKragment newInstance(){
        return new DialogQLCKragment();
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setStyle(DialogQLCKragment.STYLE_NORMAL, R.style.FullsCreen);
    }
