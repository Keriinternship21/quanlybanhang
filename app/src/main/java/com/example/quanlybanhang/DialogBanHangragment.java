...
public class DialogBanHangragment extends AppCompatDialogFragment {

    static DialogBanHangragment newInstance(){
        return new DialogBanHangragment();
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setStyle(DialogBanHangragment.STYLE_NORMAL, R.style.FullsCreen);
    }
